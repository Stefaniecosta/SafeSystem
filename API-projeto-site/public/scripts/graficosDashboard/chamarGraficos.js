...
function chamarGraf1() {
    ...
    chartCPU1.style.display = 'block';
    chartCPU2.style.display = 'none';
    chartCPU3.style.display = 'none';
    chartCPU4.style.display = 'none';
    chartCPU5.style.display = 'none';
    chartCPU6.style.display = 'none';
}
...
function chamarGraf2() {
    ...
    chartCPU1.style.display = 'none';
    chartCPU2.style.display = 'block';
    chartCPU3.style.display = 'none';
    chartCPU4.style.display = 'none';
    chartCPU5.style.display = 'none';
    chartCPU6.style.display = 'none';
